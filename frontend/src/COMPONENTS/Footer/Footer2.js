    ...
    <div className='footer'>
      ...
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>At Vegella, we offer real-time updates on vegetable prices, historical trends, and price predictions. Make informed buying and selling decisions with us. Get Fresh Groceries at your doorsteps. </p>
        </div>
        <div className='f2'>
          <h3>About Us</h3>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Vegella, Inc.  All rights reserved</h3>
